package pwr.edu.rebu.repository;

import pwr.edu.rebu.BackendApp;
import pwr.edu.rebu.config.Constants;
import pwr.edu.rebu.config.audit.AuditEventConverter;
import pwr.edu.rebu.domain.PersistentAuditEvent;
...
import static pwr.edu.rebu.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
